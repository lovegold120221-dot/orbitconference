...
echo "Releasing Orbit Meet SDK ${SDK_VERSION}"

pushd ${RELEASE_REPO}

# Generate podspec file
cat OrbitMeetSDK.podspec.tpl | sed -e s/VERSION/${SDK_VERSION}/g > OrbitMeetSDK.podspec
...
cp -a ${PROJECT_REPO}/ios/sdk/out/OrbitMeetSDK.xcframework Frameworks/
...
echo "The new pod can be pushed to CocoaPods by doing: pod trunk push OrbitMeetSDK.podspec"
