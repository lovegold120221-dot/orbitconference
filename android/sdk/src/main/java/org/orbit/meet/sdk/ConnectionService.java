...
/**
 * Orbit Meeting implementation of {@link ConnectionService}. At the time of this
...
public class ConnectionService extends android.telecom.ConnectionService {
    ...
    static final String EXTRA_PHONE_ACCOUNT_HANDLE
        = "org.orbit.meet.sdk.connection_service.PHONE_ACCOUNT_HANDLE";
    ...
    /**
     * Connection implementation for Orbit Meeting's {@link ConnectionService}.
     *
     * @author Pawel Domas
     */
    class ConnectionImpl extends Connection {
        ...
        public void onDisconnect() {
            ...
            RNConnectionService.getInstance().emitEvent(
                    "org.orbit.meet:features/connection_service#disconnect",
                    data);
        ...
        public void onAbort() {
            ...
            data.putString("callUUID", getCallUUID());
            RNConnectionService.getInstance().emitEvent(
                    "org.orbit.meet:features/connection_service#abort",
                    data);
            // The JavaScript side will not go back to the native with
            // 'endCall', so the Connection must be removed immediately.
            setConnectionDisconnected(
